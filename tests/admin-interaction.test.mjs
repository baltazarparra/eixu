...
const conversations = [
  ...
  'Dividir o bloco com uma foto seria melhor?',
  'Como dividir a seção em duas colunas?',
  'Não mude nada, quero dividir a seção só para entender a ideia.',
...
const actions = [
  ...
  'Divida a seção em duas metades com a imagem #10.',
