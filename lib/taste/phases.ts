...
2. Chame define_image_guide com estilo, luz, paleta da marca, ambientes, sujeitos e o que nunca pode aparecer. Derive a linguagem das referências visualmente lidas, adaptada ao negócio; sem leitura visual, use a vibe e declare a lacuna.
3. Compare alternativas adequadas às referências e ao negócio. Com leitura visual verificada, preencha referenceDirection com a fonte principal e aplicações em layout, typography, imagery e rhythm; essas decisões prevalecem sobre a vibe. Sem referências verificadas, respeite a faixa da vibe. Escolha pela clareza, identidade e viabilidade no catálogo. Chame set_design com briefing, conceito, elemento-assinatura, paleta e oito eixos. Inclua brief.pagePlan: slug, etapa de inbound, intenção, conteúdo útil e evidências de cada página. Inclua também brief.imageScenes, preenchendo exatamente as vagas da composição com pedido concreto e página associada. Cada página responde a uma pergunta diferente, sem inventar oferta para preencher o mínimo.
