...
Objetivo: montar o projeto completo em uma única chamada de build_site, cumprindo o briefing de composição e a voz da vibe em linguagem simples, em todos os textos.
