...
4. Na vibe Comercial, compare exclusivamente comercial-marca, comercial-imagem e comercial-informacao: a referência absoluta é minatelsupermercados.com.br/brotas e o perfil resultante é v8. Nas demais vibes com referência visual verificada, compare as doze estruturas gerais; sem referência, compare as três estruturas da vibe. Grave a escolha em structure, justifique em structureRationale e faça heroComposition corresponder à abertura. Com referência do tenant, preencha referenceDirection com aplicações concretas em layout, typography, imagery, rhythm, surface e mobile; na Comercial ela complementa marca e fotografia sem trocar o contrato v8. Chame set_design com briefing, conceito, elemento-assinatura, paleta e eixos. Inclua brief.pagePlan: slug, etapa de inbound, intenção, conteúdo útil e evidências de cada página. Inclua também brief.imageScenes, preenchendo exatamente as vagas da composição com pedido concreto e página associada. Nos perfis v5/v6, signature.composition é a protagonista autoral; na Comercial v8, feature.bento reúne as categorias ilustradas. Cada página responde a uma pergunta diferente, sem inventar oferta para preencher o mínimo.
