...
- Pedido visual de uma imagem preserva tipo, layout, textos, ordem e demais itens. Em signature.composition, use items.N.imagePresentation: frame none remove a moldura herdada e o fundo/padding do box; fit natural mantém a imagem inteira na proporção original; width container ocupa a largura do box atual; spacingTop none remove o respiro superior. Para a seção, presentation.background transparent, edge none e spacingTop none removem fundo, borda e respiro superior. Não troque layout nem gere outra imagem para obter esses efeitos. Remova foreground ao usar fundo transparente. Se faltar um controle no schema, explique esse limite sem substituir a seção.
