...
- Um fato dito pelo operador no chat, como prêmio, número ou marca, só vale como prova depois de gravado com confirm_evidence; o pre-flight lê brief.evidence, não a prévia. Grave antes de usá-lo em selo, prova ou preço e diga ao operador o que ainda falta. Não suponha que a página montada comprova o fato.
