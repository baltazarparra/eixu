...
Implementação local das fases 0–3 do [plano](landing-plan-2026-09-12.md), no
...
As fases 1 e 2 do [plano](inline-edit-plan-2026-09-12.md) foram implementadas no
...
O escopo, comparação de custo, verificações e limitações estão em [Revisão do admin](admin-review-2026-09-10.md). O manual de operação está em [Admin](../admin.md). Os registros abaixo preservam as evidências de cada entrega anterior e não devem ser lidos como uma medição da versão atual.
...
## Correções do PR #2, registro histórico
