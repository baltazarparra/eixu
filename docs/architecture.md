...
O PATCH de Dados também bloqueia mudança de história, referência ou vibe durante
um run ativo. Quando história ou referência muda, remove do rascunho o briefing
derivado e o plano de cenas, preserva páginas, `brand.design` e o snapshot
publicado, e sinaliza que a nova direção exige reconstrução.
