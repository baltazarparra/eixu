...
- Cinco vibes com contratos próprios de tipografia, abertura, navegação, ritmo, superfície, iconografia, imagem e [voz de escrita](docs/copy.md). A Comercial v8 usa a Minatel Brotas como referência absoluta e oferece uma jornada completa com hero, ligação institucional entre a fachada e os setores, história, categorias, social, imagem imersiva, formulário, mapa e rodapé. As outras vibes multipágina preservam as estruturas v5/v6; Landing Page usa perfil v7. Referências visuais verificadas continuam dirigindo v6 e complementam marca e fotografia na Comercial; a voz sempre usa linguagem simples.
...
- Conversão Premium de um site publicado para um workspace próprio em `apps/premium/<cliente>`, com dependências isoladas, Creative Developer orientado por `apps/premium/SOUL.md` e publicação automática na mesma URL após o merge. Depois da ativação, o chat dá lugar a um CMS de textos e imagens com prévia do frontend Premium; leads, tracking, WhatsApp, imagens e métricas continuam ligados ao tenant central.
...
| `npm run premium:check -- <project-key>`                     | Executa typecheck, lint, build e validação do contrato para um único projeto Premium.                                                                                             |
