...
- Quatro vibes com direção de arte, imagens e [voz de escrita](docs/copy.md) próprias. Referências visuais do cadastro prevalecem na estrutura, tipografia, imagens e ritmo; a voz continua usando a vibe e linguagem simples.
